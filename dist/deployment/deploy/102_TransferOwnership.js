...
const transferOwnership_1 = require("../../tasks/transferOwnership");
...
const func = async (hre) => {
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, DLLR.address, targetOwner);
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, MassetManager.address, targetOwner);
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, FeesVault.address, targetOwner);
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, FeesManager.address, targetOwner);
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, BasketManagerV3.address, targetOwner);
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, MocIntegration.address, targetOwner);
    ...
    await (0, transferOwnership_1.transferOwnership)(hre, MyntAdminProxy.address, targetOwner);
