...
describe("SIP-0072 onchain test", () => {
    ...
    it("SIP-0072 is executable", async () => {
        ...
        expect(await myntAdminProxy.getProxyImplementation(bmProxyDeployment.address)).to.equal(bmDeployment.implementation);
        expect(await myntAdminProxy.getProxyImplementation(mmProxyDeployment.address)).to.equal(mmDeployment.implementation);
        expect(await myntAdminProxy.getProxyImplementation(fmProxyDeployment.address)).to.equal(fmDeployment.implementation);
        expect(await myntAdminProxy.getProxyImplementation(fvProxyDeployment.address)).to.equal(fvDeployment.implementation);
