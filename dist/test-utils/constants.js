 ...
 */
exports.ratioScale = new tools_1.BN(10).pow(new tools_1.BN(8));
exports.fullScale = new tools_1.BN(10).pow(new tools_1.BN(18));
exports.DEAD_ADDRESS = "0x0000000000000000000000000000000000000001";
exports.ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";
exports.FEE_PRECISION = new tools_1.BN(10000);
exports.MAX_UINT256 = new tools_1.BN(2).pow(new tools_1.BN(256)).sub(new tools_1.BN(1));
exports.MAX_INT128 = new tools_1.BN(2).pow(new tools_1.BN(127)).sub(new tools_1.BN(1));
exports.MIN_INT128 = new tools_1.BN(2).pow(new tools_1.BN(127)).mul(new tools_1.BN(-1));
exports.ZERO = new tools_1.BN(0);
exports.ONE_MIN = new tools_1.BN(60);
exports.TEN_MINS = new tools_1.BN(60 * 10);
exports.ONE_HOUR = new tools_1.BN(60 * 60);
exports.ONE_DAY = new tools_1.BN(60 * 60 * 24);
exports.FIVE_DAYS = new tools_1.BN(60 * 60 * 24 * 5);
exports.TEN_DAYS = new tools_1.BN(60 * 60 * 24 * 10);
exports.ONE_WEEK = new tools_1.BN(60 * 60 * 24 * 7);
exports.ONE_YEAR = new tools_1.BN(60 * 60 * 24 * 365);
exports.KEY_SAVINGS_MANAGER = web3_utils_1.default.keccak256("SavingsManager");
exports.KEY_PROXY_ADMIN = web3_utils_1.default.keccak256("ProxyAdmin");
