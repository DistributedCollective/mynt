...
export interface IMocMintRedeemDocInterface extends utils.Interface {
    functions: {
...
export interface IMocMintRedeemDoc extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IMocMintRedeemDocInterface;
