...
export interface BasketManagerV3Interface extends utils.Interface {
    functions: {
...
export interface BasketManagerV3 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BasketManagerV3Interface;
