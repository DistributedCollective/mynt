...
export interface MassetInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "getBasketManager" | "getToken" | "getVersion" | "initialize" | "mint" | "mintTo" | "onTokensMinted" | "owner" | "redeem" | "redeemTo" | "redeemToBridge(address,uint256,address,address)" | "redeemToBridge(address,uint256,address)" | "renounceOwnership" | "tokensReceived" | "transferOwnership"): FunctionFragment;
...
export interface Masset extends BaseContract {
    ...
    functions: {
        ...
        initialize(_basketManagerAddress: PromiseOrValue<string>, _tokenAddress: PromiseOrValue<string>, _registerAsERC777RecipientFlag: PromiseOrValue<boolean>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getToken(overrides?: CallOverrides): Promise<string>;
        getVersion(overrides?: CallOverrides): Promise<string>;
        initialize(_basketManagerAddress: PromiseOrValue<string>, _tokenAddress: PromiseOrValue<string>, _registerAsERC777RecipientFlag: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
