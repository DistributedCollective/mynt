...
export interface MockMetaAssetTokenInterface extends utils.Interface {
    functions: {
...
export interface MockMetaAssetToken extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockMetaAssetTokenInterface;
