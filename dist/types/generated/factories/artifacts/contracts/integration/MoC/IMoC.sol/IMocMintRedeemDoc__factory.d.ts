...
import type { IMocMintRedeemDoc, IMocMintRedeemDocInterface } from "../../../../../../artifacts/contracts/integration/MoC/IMoC.sol/IMocMintRedeemDoc";
export declare class IMocMintRedeemDoc__factory {
    ...
    static createInterface(): IMocMintRedeemDocInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IMocMintRedeemDoc;
}
