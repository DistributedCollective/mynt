...
const saveUpdatedStaker = async (oldData: StakerInfo, newStakers: StakerInfo[]): Promise<void> => {
...
const appendRestOfNewStakers = async (restOfStakers: StakerInfo[]): Promise<void> => {
